...
import { X, Network, ChevronRight, Users, Building, User, PieChart, Star, TrendingUp } from 'lucide-react';
          ...
          {isScaleMode && !isDetailMode ? (
            <div className="sh-scale-container">
              ...
              <div className="sh-scale-topbar">
                ...
                <button className="sh-scale-back-btn" onClick={() => setIsScaleMode(false)}>
                  돌아가기
                </button>
              </div>
