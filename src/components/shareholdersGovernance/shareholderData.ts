...
export const SHAREHOLDER_DATA: (CompanyShareholders & { shareholders: Shareholder[] })[] = [
  {
    ...
    shareholders: [
      { name: '개인주주1',      type: '개인', pct: '30.7%' },
      { name: '개인주주2',      type: '개인', pct: '10.0%' },
      { name: '개인주주3',      type: '개인', pct: '6.0%' },
  ...
  },
  {
    ...
    shareholders: [
      { name: '개인주주1',      type: '개인', pct: '35.3%' },
      { name: '개인주주2',      type: '개인', pct: '10.0%' },
      { name: '개인주주3',      type: '개인', pct: '5.0%' },
  ...
  },
  {
    ...
    shareholders: [
      ...
      { name: '개인주주1',      type: '개인', pct: '20.0%' },
      { name: '개인주주2',      type: '개인', pct: '15.0%' },
      { name: '개인주주3',      type: '개인', pct: '9.0%' },
  ...
  },
  {
    ...
    shareholders: [
      ...
      { name: '개인주주1',      type: '개인', pct: '22.0%' },
      { name: '개인주주2',      type: '개인', pct: '12.0%' },
      { name: '개인주주3',      type: '개인', pct: '6.0%' },
    ],
  },
  {
    ...
    shareholders: [
      ...
      { name: '개인주주1',      type: '개인', pct: '22.0%' },
      { name: '개인주주2',      type: '개인', pct: '16.1%' },
      { name: '개인주주3',      type: '개인', pct: '4.5%' },
  ...
  },
  {
    ...
    shareholders: [
      { name: '개인주주1',      type: '개인', pct: '45.0%' },
      { name: '개인주주2',      type: '개인', pct: '28.0%' },
      { name: '개인주주3',      type: '개인', pct: '9.0%' },
      { name: '개인주주4',      type: '개인', pct: '15.0%' },
      { name: '기타',           type: '개인', pct:  '3.0%' },
    ],
  },
  {
  ...
  },
  {
    ...
    shareholders: [
      { name: '개인주주1',      type: '개인', pct: '35.0%' },
      { name: '개인주주2',      type: '개인', pct: '30.0%' },
      { name: '개인주주3',      type: '개인', pct: '20.0%' },
      { name: '개인주주4',      type: '개인', pct: '15.0%' },
    ],
  },
];
